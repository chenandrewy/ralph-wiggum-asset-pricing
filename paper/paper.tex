...
The model delivers closed-form price-dividend ratios, and quantitative analysis shows that P/D ratios for AI stocks can reach roughly twice those of non-AI stocks across plausible singularity probabilities, consistent with observed valuation spreads. Extinction risk \citep{Jones2024} attenuates this gap: the states in which AI is powerful enough to produce enormous growth are also those in which existential risk is highest, reducing the probability weight on the non-extinction states where the hedging channel operates. The same incomplete markets that inflate AI valuations also distort real decisions. Market incompleteness distorts the development of AI itself. When the positive singularity is more likely than the negative one, AI development is socially efficient. Yet a risk-averse household that cannot hedge displacement may rationally choose to block it---the uninsurable downside looms larger than the expected upside. Complete markets would eliminate this distortion, connecting the model to debates about AI regulation: calls to slow or halt AI development may partly reflect investors' inability to share in its upside.
