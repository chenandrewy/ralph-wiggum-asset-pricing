...
We define a \emph{negative} AI singularity as a sudden, dramatic improvement in AI productivity that displaces the typical investor's labor income and consumption. Part of this premium, we argue, reflects a hedging motive: because markets are incomplete---investors cannot trade the restricted equity of AI owners---publicly traded AI stocks serve as the only available partial hedge against displacement, pushing their valuations above those of non-AI stocks.

Why can't investors simply insure against displacement? Much of the relevant equity is restricted---held by founders, early-stage investors, and firms that may not yet exist. As \citet{GKP2012} emphasize, the displacing capital often belongs to future innovators who have not yet entered the economy, so broader trading of AI capital faces fundamental limits. This market incompleteness forces investors into publicly traded AI stocks as an imperfect substitute, creating the valuation premium we study.

To formalize this mechanism, we build on \citet{GKP2012}'s framework by modeling a discrete AI singularity with severe displacement. In our consumption-based model, a representative household---the marginal investor---faces a stochastic singularity that shifts consumption toward AI owners holding private capital. AI stocks grow as a share of the economy with each singularity, making them a partial hedge. The model delivers closed-form price-dividend ratios, and quantitative analysis shows that P/D ratios for AI stocks can reach roughly twice those of non-AI stocks across plausible singularity probabilities, consistent with observed valuation spreads. Extinction risk \citep{Jones2024} attenuates this gap: the states in which AI is powerful enough to produce enormous growth are also those in which existential risk is highest, reducing the probability weight on the non-extinction states where the hedging channel operates.

The model has a second implication, for real decisions rather than just prices. Incomplete markets distort the efficient development of AI. When the positive singularity is more likely than the negative one, AI development is socially efficient. Yet a risk-averse household that cannot hedge displacement may rationally choose to block it---the uninsurable downside looms larger than the expected upside. Complete markets would eliminate this distortion: as Proposition~\ref{prop:veto} shows, calls to slow or halt AI development may partly reflect investors' inability to share in its upside.

If incomplete markets create the problem, can policy fix it? The ideal solution is broader trading of AI capital, but the fundamental limits just described---non-existent future capital, restricted ownership---make this infeasible. Government transfers offer an alternative, though they ordinarily incur deadweight costs that consume much of their value. In a singularity with explosive output growth \citep{Jones2024}, however, the resource base becomes so enormous that even grossly inefficient redistribution delivers large consumption gains. The same explosive growth that drives the incomplete-markets problem also provides the means for its resolution.

Section~\ref{sec:model} presents the model and derives equilibrium prices. Section~\ref{sec:quant} provides quantitative analysis. Section~\ref{sec:extensions} develops extensions on AI development distortions and government transfers. Section~\ref{sec:conclusion} concludes. This paper is itself a product of the displacement it models: all analysis, code, and prose were produced by AI agents from a human-authored economic specification and test scripts, requiring zero traditional research labor.
