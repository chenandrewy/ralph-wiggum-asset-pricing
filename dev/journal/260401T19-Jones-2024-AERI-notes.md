# Jones 2024 AERI Notes (retrieved from dev/tmp/)
**Date:** 2026-04-01
**Note:** This is an old file retrieved from `dev/tmp/Jones-2024-AERI-notes.md` and saved to the journal for archival.
